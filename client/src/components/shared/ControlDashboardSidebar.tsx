...
const sidebarRoutesGroup1: RouteItem[] = [
  ...
  },
  {
    ...
    children: [
      { label: 'Customers Wallet', path: '/control-dashboard/wallets/customers' },
      { label: 'Submissions', path: '/control-dashboard/wallets/submissions' },
    ],
  },
  {
    label: 'Users',
  ...
  },
  {
    ...
    roles: [AdministratorLevel.SUPER_ADMIN, AdministratorLevel.ADMIN],
   path: '/control-dashboard/transactions/all'
  },
  {
    label: 'Pay Methods',
