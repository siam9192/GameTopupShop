                  ...
                  <Box minWidth={250}>
                    ...
                    <FormControl fullWidth>
                      ...
                      >
                        ...
                        <MenuItem value={'Active'}>Topup</MenuItem>
                        <MenuItem value={'Blocked'}>Offer</MenuItem>
                      </Select>
                    </FormControl>
                  </Box>
           ...
           {/* Button */}
                  <Box marginTop={5.5}>
                    <button
                      ...
                      className="w-full px-2 py-4 rounded-lg bg-primary hover:bg-primary/80 text-white font-medium "
                    >
                      Search
                    </button>
                  </Box>
