...
import {
  getLivePaymentMethodsQuery,
  updateLivePaymentMethodStatusMutation,
} from '@/query/services/live-payment-method';
...
function page() {
  ...
  const handelUpdateStatus = (id: string, status: LivePaymentMethodStatus) => {
    mutate(
      {
        id,
        status,
                      ...
                      >
                        ...
                        <Button
                          ...
                          onClick={() =>
                            handelUpdateStatus(
                              method._id,
                              method.status === LivePaymentMethodStatus.ACTIVE
                                ? LivePaymentMethodStatus.INACTIVE
                                : LivePaymentMethodStatus.ACTIVE,
                            )
                          }
                        >
                          {buttonText}
