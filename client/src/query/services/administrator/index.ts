import {
  ...
  deleteAdministrator,
  createAdministrator,
} from '@/api-services/administrator';
...
export function createAdministratorMutation() {
  return useMutate<IResponse<Administrator>, any>(createAdministrator);
}
...
export function updateAdministratorLevelMutation() {
  return useMutate<IResponse<null>, { id: string; level: AdministratorLevel }>(
    updateAdministratorLevel,
  );
}
