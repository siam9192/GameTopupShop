...
const envConfig = {
  ...
  fastForex: {
    apiKey: process.env.FAST_FOREX_API_KEY,
  },
  exchange_rate: {
  ...
  orderPayment: {
    success_url: process.env.ORDER_PAYMENT_SUCCESS_URL,
    cancel_url: process.env.ORDER_PAYMENT_CANCEL_URL,
    fail_url: process.env.ORDER_PAYMENT_FAIL_URL,
    token_secret: process.env.ORDER_PAYMENT_TOKEN_SECRET,
  },
  walletAddBalancePayment: {
    success_url: process.env.WALLET_ADD_BALANCE_PAYMENT_SUCCESS_URL,
    cancel_url: process.env.WALLET_ADD_BALANCE_PAYMENT_CANCEL_URL,
    fail_url: process.env.WALLET_ADD_BALANCE_PAYMENT_FAIL_URL,
    token_secret: process.env.WALLET_ADD_BALANCE_PAYMENT_TOKEN_SECRET,
  },
};
