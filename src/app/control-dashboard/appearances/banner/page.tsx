  ...
  return (
    <div>
         ...
         <Grid marginTop={2} container  columns={{xs:2,lg:3}} spacing={{xs:3,md:5}}>
       {
        Array.from({length:10}).map((_,index)=>(
            ...
            <Box >
                <Typography color='secondary' fontWeight={600} fontFamily={'jost'} fontSize={23}>No: {index+1}</Typography>
                <div className='relative group hover:scale-90 hover:cursor-pointer duration-75'>
                     <img src="http://localhost:3000/_next/image?url=https%3A%2F%2Fstaticg.sportskeeda.com%2Feditor%2F2021%2F12%2F606e9-16392154686721-1920.jpg%3Fw%3D640&w=1200&q=75" alt="" className='mt-3 outline-2 outline-offset-4 rounded-lg outline-secondary  group-hover:outline-primary  ' />
   ...
   <Grid size={1}>
     <Box height={'100%'} flexDirection={'column'} display={'flex'}>
                <Typography color='text.primary' fontWeight={600} fontFamily={'jost'} fontSize={23}>Add New</Typography>
         ...
         <Stack direction={'row'} gap={2} marginTop={5} justifyContent={'end'}>
