  ...
  return (
    <>
      <form
        ...
        className="w-full  lg:w-1/2  mx-auto glass p-6 rounded-xl space-y-8"
      >
        {/* --- Form Fields --- */}
        <div>
          ...
          >
            {paymentOptions.map((option, index) => (
              <Paper
                ...
                className={`cursor-pointer transition-all border-2 p-3 rounded-lg flex items-center gap-3 w-full sm:w-auto shadow-none ${
