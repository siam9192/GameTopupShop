    ...
    <div className=' p-2 md:p-3 relative'>
      <Stack direction={{
        ...
        md:"row"
          ...
          <Avatar src='https://play-lh.googleusercontent.com/Odw8BGugaJLdbaSbCeZWbTE3Qz1wTiQ0Tsn9nzpoQdnkzWb-gaI58zzTmYDvGpdYKg' variant='rounded'>
        </Avatar>
         <Stack spacing={.5}>
              <Typography fontWeight={500} fontSize={20} color='text.primary'>
            Free fire
            </Typography>
                <Stack marginTop={2} direction={'row'} alignItems={'center'} spacing={{
                    xs:1,
                    md:2
                }}>
            <Typography fontWeight={500} fontSize={{
                xs:14,
                lg:16
          ...
          Status:<Typography fontSize={'inherit'} component={'span'} display={'inline'} fontWeight={500}  color='success'> Success</Typography>
            </Typography>
