    ...
    <div className=" p-2">
      <Stack direction={'row'} spacing={1}>
        ...
        <div>
          ...
          <p className='text-txt-secondary' dangerouslySetInnerHTML={{ __html: notification.message }}></p>
        </div>
      </Stack>
      <div className="text-end">
        <Button onClick={handelSetAsRead} disabled={isPending} variant="outlined">Mark as Read</Button>
      </div>
    </div>
  );
}
